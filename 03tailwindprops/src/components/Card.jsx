...
function Card({username, btnText="visit me"}) { // we can also set default value for props by using destructuring assignment
    console.log("username  is: ",username);
    // console.log("username  is: ",props.username); no need to destrucure props, we can directly access it by using the name of the prop
